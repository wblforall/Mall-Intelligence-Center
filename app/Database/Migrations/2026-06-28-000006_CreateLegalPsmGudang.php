...
class CreateLegalPsmGudang extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'nama_penyewa'       => ['type' => 'VARCHAR', 'constraint' => 150],
            'lokasi_gudang'      => ['type' => 'VARCHAR', 'constraint' => 200],
        ...
        $this->forge->createTable('legal_psm_gudang');
    }

    public function down()
    {
        $this->forge->dropTable('legal_psm_gudang', true);
    }
}
