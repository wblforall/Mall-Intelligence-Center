...
class PromoMediaCtrl extends BaseController
{
    ...
    public function batchApprove()
    {
        ...
        foreach ($approveIds as $id) {
            ...
            // Notifikasi hasil ke pengaju — jalur batch inilah yang dipakai UI
            // (tombol di halaman pending), jadi tanpa ini pengaju tak pernah tahu.
    ...
    public function rejectBatch()
    {
        ...
        foreach ($ids as $id) {
            ...
            // Notifikasi hasil + alasan ke pengaju (jalur batch = yang dipakai UI)
            \App\Libraries\Notify::send(
