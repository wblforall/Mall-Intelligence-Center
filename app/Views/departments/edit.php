...
<?php
$firstEventKey = true;
$standaloneKeys = ['events', 'loyalty_main', 'creative_main', 'vm_main', 'sponsorship_main', 'people_dev', 'hr_main', 'traffic', 'parking_live', 'parking_vehicles', 'parking_revenue', 'legal'];
