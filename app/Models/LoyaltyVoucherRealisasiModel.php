...
class LoyaltyVoucherRealisasiModel extends Model
{
    protected $table         = 'loyalty_voucher_realisasi';
    ...
    // Monthly totals keyed by item_id
    ...
    {
        if (empty($itemIds)) return [];
        return $this->db->table('loyalty_voucher_realisasi')
